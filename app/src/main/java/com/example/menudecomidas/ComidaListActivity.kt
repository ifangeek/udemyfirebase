 ...
 * lead to a [ComidaDetailActivtiy] representing
...
class ComidaListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSave.setOnClickListener {
            val comida : DummyContent.Comida  = DummyContent.Comida(etName.text.toString().trim(),etPrice.text.toString().trim())
        ...
        init {
            onClickListener = View.OnClickListener { v ->
                ...
                if (twoPane) {
                    ...
                    val intent = Intent(v.context, ComidaDetailActivtiy::class.java).apply {
